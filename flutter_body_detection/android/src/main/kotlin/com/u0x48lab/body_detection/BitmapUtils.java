...
public class BitmapUtils {
  ...
  @Nullable
  public static Bitmap getBitmap(ByteBuffer data, int width, int height, int rotation, boolean flipX) {
    data.rewind();
    ...
    try {
      ...
      stream.close();
      return rotateBitmap(bmp, rotation, flipX, false);
    } catch (Exception e) {
  ...
  public static Bitmap getBitmap(ImageProxy image, boolean flipX) {
    ...
    return getBitmap(nv21Buffer, image.getWidth(), image.getHeight(), image.getImageInfo().getRotationDegrees(), flipX);
  }
